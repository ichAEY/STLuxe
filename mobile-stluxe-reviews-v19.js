(function(){
  ...
  @media(max-width:767px){
    ...
    #stluxe-tanem-v13 #tn13Reviews .tn19-score{text-align:center;margin-top:25px}
    ...
    #stluxe-tanem-v13 #tn13Reviews .tn19-stars{margin-top:15px;font-size:22px;line-height:1;letter-spacing:4px;color:#d9b56f}
    #stluxe-tanem-v13 #tn13Reviews .tn19-count{margin-top:14px;font-family:"Manrope",Arial,sans-serif;font-size:11px;font-weight:400;line-height:1;color:#d4ccc5}
    #stluxe-tanem-v13 #tn13Reviews .tn19-list{display:grid;gap:9px;margin-top:20px}
    ...
    #stluxe-tanem-v13 #tn13Reviews .tn19-all{display:flex;align-items:center;justify-content:center;gap:12px;margin-top:17px;color:#cfbfae;text-decoration:none!important;font-family:"Manrope",Arial,sans-serif;font-size:9px;font-weight:500;line-height:1;letter-spacing:.35em;text-transform:uppercase}
