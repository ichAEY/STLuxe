(function(){
  ...
  const salonPhotos=[
    ...
    'assets/images/nails-light.webp',
  ...
  @media(max-width:767px){
    ...
    .fx-visit-list{display:grid;gap:0}.fx-visit-row{display:grid;grid-template-columns:36px 1fr;gap:10px;padding:14px 0;border-bottom:1px solid #e9e9e9}.fx-visit-row svg{width:19px;height:19px;margin-top:2px}.fx-visit-row strong{font-size:14px;font-weight:500;display:block;margin-bottom:3px}.fx-visit-row span{font-size:13px;color:#666;line-height:1.45}.fx-map{width:100%;height:240px;border:0;border-radius:18px;margin-top:18px;background:#eee}.fx-visit-actions{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px}.fx-visit-actions a{height:46px;border:1px solid #d9d9d9;border-radius:999px;display:flex;align-items:center;justify-content:center;text-decoration:none;font-size:14px}.fx-visit-actions a:last-child{background:#111!important;color:#fff!important;border-color:#111!important}
