...
(function(){
  ...
  @media(max-width:767px){
    ...
    .tn50-book-title{margin:17px 50px 0 0;font:500 38px/.95 "Cormorant Garamond",Georgia,serif;letter-spacing:-.025em}.tn50-book-copy{margin:12px 42px 0 0;color:#736861;font-size:11.5px;line-height:1.5}.tn50-book-options{display:grid;gap:8px;margin-top:22px}.tn50-book-option{width:100%;min-height:62px;border:1px solid rgba(66,52,45,.12);border-radius:14px;padding:9px 12px;display:grid;grid-template-columns:38px minmax(0,1fr) auto;align-items:center;gap:11px;background:rgba(255,255,255,.58);color:#211d1a!important;text-align:left;text-decoration:none!important}.tn50-book-option.is-pending{cursor:default}.tn50-book-icon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:#eee4dd;color:#6d5b53;font:600 10px/1 "Manrope",Arial,sans-serif}.tn50-book-option strong{display:block;font:500 13px/1.2 "Manrope",Arial,sans-serif}.tn50-book-option small{display:block;margin-top:5px;color:#877970;font:400 9.5px/1.2 "Manrope",Arial,sans-serif}.tn50-book-arrow{color:#9b8e86;font-size:17px}
  }
  ...
  root.innerHTML=`
    ...
    <section class="tn13-final" id="tn13Visit">
      <div class="tn13-shell tn13-reveal">
        ...
        <div class="tn13-final-actions">
          ...
          <div class="tn13-final-secondary-row"><a class="tn13-final-secondary" href="${WHATSAPP_URL}" target="_blank" rel="noopener">WhatsApp</a><button class="tn13-final-secondary" type="button" disabled style="background:transparent">MAX</button><a class="tn13-final-secondary" href="tel:${PHONE}">Позвонить</a><a class="tn13-final-secondary" href="${YANDEX}" target="_blank" rel="noopener">Яндекс Карты</a></div>
        </div>
    ...
    <div class="tn13-sheet" id="tn13BookSheet" role="dialog" aria-modal="true" aria-labelledby="tn50BookTitle"><div class="tn13-panel"><button class="tn13-close" id="tn13BookClose" type="button" aria-label="Закрыть">×</button><p class="tn13-kicker">Запись</p><h2 class="tn50-book-title" id="tn50BookTitle">Как вам удобнее записаться?</h2><p class="tn50-book-copy">Выберите удобный способ связи.</p><div class="tn50-book-options"><a class="tn50-book-option" href="tel:${PHONE}"><span class="tn50-book-icon">☎</span><span><strong>Позвонить</strong><small>+7 (916) 355-22-22</small></span><span class="tn50-book-arrow">→</span></a><a class="tn50-book-option" href="${WHATSAPP_URL}" target="_blank" rel="noopener"><span class="tn50-book-icon">WA</span><span><strong>Написать в WhatsApp</strong><small>Откроется чат с салоном</small></span><span class="tn50-book-arrow">→</span></a><button class="tn50-book-option is-pending" type="button" disabled><span class="tn50-book-icon">MAX</span><span><strong>MAX</strong></span><span></span></button></div></div></div>
  `;
...
console.assert(SERVICES.length===190,'STLuxe services count',SERVICES.length);
...
.tn50-contact-mark{width:32px;height:32px;border-radius:10px;display:grid!important;place-items:center;background:#ede4dd;color:#75655c!important;margin:0!important;font:600 9px/1 'Manrope',Arial,sans-serif!important}.tn22-contact.is-pending{width:100%;cursor:default;text-align:left;font:inherit}
...
visit.innerHTML=`<div class="tn22-visit"><div class="tn22-visit-head"><p class="tn22-kicker">Контакты</p><span class="tn22-status" id="tn22Status">${clock}<span class="tn22-status-text"></span></span></div><h2>Ждём вас</h2><div class="tn22-contact-grid"><a class="tn22-contact" href="${YANDEX_RU}" target="_blank" rel="noopener">${pin}<span><strong>Ивантеевка, ул. Победы, 16</strong><span>Московская область · открыть в Яндекс Картах</span></span></a><a class="tn22-contact" href="tel:${PHONE}">${ph}<span><strong>+7 (916) 355-22-22</strong><span>Нажмите, чтобы позвонить</span></span></a><a class="tn22-contact" href="${WHATSAPP_URL}" target="_blank" rel="noopener"><span class="tn50-contact-mark">WA</span><span><strong>WhatsApp</strong><span>Написать в салон</span></span></a><button class="tn22-contact is-pending" type="button" disabled><span class="tn50-contact-mark">MAX</span><span><strong>MAX</strong></span></button><div class="tn22-contact">${clock}<span><strong>Вт–Вс 10:00–20:00</strong><span>Понедельник — выходной</span></span></div></div><div class="tn22-mapwrap"><div class="tn22-map-skeleton">Загружаем карту…</div><iframe title="Карта STLuxe" loading="eager" src="https://yandex.ru/map-widget/v1/?mode=search&text=%D0%98%D0%B2%D0%B0%D0%BD%D1%82%D0%B5%D0%B5%D0%B2%D0%BA%D0%B0%2C%20%D1%83%D0%BB.%20%D0%9F%D0%BE%D0%B1%D0%B5%D0%B4%D1%8B%2C%2016&z=16"></iframe></div><div class="tn22-visit-actions"><a class="tn22-visit-btn tn22-call" href="tel:${PHONE}">Позвонить</a><a class="tn22-visit-btn tn22-route" href="${ROUTE}" target="_blank" rel="noopener">Построить маршрут</a></div><a class="tn22-footer" href="https://tanem.ru/" target="_blank" rel="noopener"><strong>TANEM.ru</strong><span>Цифровой офис для салонов красоты</span></a></div>`;
