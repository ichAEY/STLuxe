...
.tn50-contact-icon{width:32px;height:32px;border-radius:10px;display:grid!important;place-items:center;background:#ede4dd;color:#75655c!important;margin:0!important}.tn50-contact-icon svg{width:18px!important;height:18px!important}.tn50-contact-icon.whatsapp{background:#e9f7f0;color:#128c7e!important}.tn50-contact-icon.max{background:#efebff;color:#471aff!important}.tn50-contact-icon.phone{background:#eee4dd;color:#211d1a!important}.tn50-contact-icon.phone svg{stroke:currentColor!important}.tn50-brand-svg{fill:currentColor!important;stroke:none!important}.tn22-contact.is-pending{width:100%;cursor:default;text-align:left;font:inherit;opacity:1}
