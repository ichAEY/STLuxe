...
about.id='tn38About';
about.innerHTML=`<div class="tn42-about"><p class="tn42-kicker">О нас</p><div class="tn42-card"><div class="tn42-photo"><img src="assets/images/stluxe-about-dark.svg" alt="STLux" loading="lazy"><div class="tn42-rating"><span class="tn42-rating-star">★</span><strong>4,9</strong><span>рейтинг салона</span></div></div><div class="tn42-body"><p class="tn42-lead">Мы сделали STLuxe местом, где можно спокойно доверить свою красоту мастеру.</p><p class="tn42-copy">Нам важно, чтобы вам было комфортно на каждом этапе: мы внимательно относимся к пожеланиям, ценим аккуратную работу и собираем в одном пространстве мастеров разных направлений.</p><div class="tn42-facts"><div class="tn42-fact">Мастера разных направлений</div><div class="tn42-fact">Комфортная атмосфера</div><div class="tn42-fact">Индивидуальный подход</div></div></div></div></div>`;
